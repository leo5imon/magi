    ...
    if (req.method === 'POST') {
      ...
      for (const file of data.files.files) {
        ...
        try {
            ...
            res.status(200).json({ message: 'File uploaded successfully!', url: Location });
            const tags = await replicate.run(
              "yorickvp/llava-13b:e272157381e2a3bf12df3a8edd1f38d1dbd736bbb7437277c8b34175f8fce358",
              {
              input: {
                  image: Location,
                  prompt: "Label this image. It can describe the color of the image, the content of the image, the type of the image, the mood of it and text written on it.",
                  top_p: 1,
                  max_tokens: 512,
                  temperature: 0.01,
              }}
